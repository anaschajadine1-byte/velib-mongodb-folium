...
| Planificateur interactif | Réussi | Deux clics réels dans le navigateur : deux combinaisons, stations, marche, vélo et durées affichés | Distance estimée, sans routage routier |
